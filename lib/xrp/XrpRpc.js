...
class XrpRpc {
  ...
  async stop() {
    return await new Promise(async (resolve, reject) => {
      try {
        // this.rpc.removeAllListeners('ledger');
        // this.rpc.removeAllListeners('connected');
        // this.rpc.removeAllListeners('disconnected');
        // await this.rpc.connection.disconnect();
        await this.rpc.disconnect();
        this.rpc.isConnected();
      } catch(err) {
        reject(err);
      }
